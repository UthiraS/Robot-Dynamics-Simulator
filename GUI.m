function createRobotSimulatorApp()
    ...
    global robotAxes robotPanel plotPanel posXCheckbox posYCheckbox posZCheckbox externalForceField externalPathField Ftip Path;
    % Main figure
...
function animateRobot(src, event)
   global robotAxes robot robotPanel Ftip path;
